...
#include "hash_tables.h"
/**
 * shash_table_create - function that create hash table.
 *
...
/**
 * shash_table_print - function that print  hash table.
...
/**
 * shash_table_print_rev - function that print  sorted hash table in reverse.
 * @ht: pointer to hash table to be printed.
 *
 * Return: No return.
 */
